...
class AddReflectionViewModel: ObservableObject {
    ...
    func clearForm() {
        ...
        lo5 = false; lo6 = false; lo7 = false; lo8 = false
        errorMessage = nil
        suggestionError = nil
    ...
    func validate() -> Bool {
        ...
        if !hasAnyLearningOutcome() {
            errorMessage = "Select at least one learning outcome."
            return false
        }
        errorMessage = nil
        return true
    ...
    func fetchLLMSuggestion() {
        ...
        guard !loNames.isEmpty else {
            errorMessage = "Select at least one learning outcome for AI suggestion."
            return
        }
        ...
        Task {
            do {
                ...
                let (suggestionTitle, suggestionSummary, suggestionContent) = try await llmService.suggestFullReflection(
